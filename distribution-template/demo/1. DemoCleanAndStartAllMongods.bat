...
sleep 300
START "mongo-17" mongo --eval "rs.initiate({ _id:'rs0', members:[{_id: 0, host:'localhost:27017', priority:10}, {_id: 1, host:'localhost:27018', priority:6}, {_id: 2, host:'localhost:27019', priority:3}]})"
